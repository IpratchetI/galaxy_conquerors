...
describe('classnames', () => {
	...
	test('classnames with additional classes', () => {
		...
		expect(classnames('defaultClass', {}, ['class1', 'class2'])).toBe(
			result
		)
	})
	...
	test('classnames with mods', () => {
		...
		expect(
			classnames('defaultClass', { hovered: true, scrolled: true }, [
				'class1',
				'class2'
			])
		).toBe(result)
	...
	test('classnames with disabled mod', () => {
		...
		expect(
			classnames('defaultClass', { hovered: true, scrolled: false }, [
				'class1',
				'class2'
			])
		).toBe(result)
	...
	test('classnames with undefined mod', () => {
		...
		expect(
			classnames('defaultClass', { hovered: true, scrolled: undefined }, [
				'class1',
				'class2'
			])
		).toBe(result)
